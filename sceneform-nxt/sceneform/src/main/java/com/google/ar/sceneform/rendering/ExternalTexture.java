...
public class ExternalTexture {
    ...
    //This is for Camera preview - fixed black camera preview om filament >= 1.68.1

    /**
     * ARCore camera textures
     *
     * Are already GPU-owned
     *
     * Must be imported, not streamed
     *
     * Must use samplerExternal
     *
     * Must NOT be uploaded, mipmapped, or wrapped in SurfaceTexture
     *
     * If you ever see a black camera in Filament → it’s almost always this mistake.
     * @param textureId
     */
    public ExternalTexture(int textureId) {
        ...
        filamentTexture = new Texture.Builder()
                .importTexture(textureId)                 // REQUIRED
                .sampler(Texture.Sampler.SAMPLER_EXTERNAL)
                .format(Texture.InternalFormat.RGB8)      // ignored, but required
                .build(engine);
