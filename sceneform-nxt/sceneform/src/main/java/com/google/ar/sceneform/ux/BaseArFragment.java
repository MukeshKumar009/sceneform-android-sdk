...
public abstract class BaseArFragment extends Fragment
    ...
    protected void  requestDangerousPermissions() {
        ...
        //TODO : Use ARCore PermissionHelper.requestCameraPermission(this); instead
...
//        }
     ...
     * - Specifies additional features for creating an ARCore {@link Session}.
     * See {@link Session.Feature}.
     * <p>
