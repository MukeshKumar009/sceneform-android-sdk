...
import com.google.ar.sceneform.sceneformext.SceneViewKt;
import com.google.ar.sceneform.sceneformext.environment.KTXEnvironmentKt;
import com.google.ar.sceneform.sceneformext.light.LightKt;
import com.google.ar.sceneform.sceneformext.util.ResourceLoaderKt;
import com.google.ar.sceneform.utilities.AndroidPreconditions;
import com.google.ar.sceneform.utilities.MovingAverageMillisecondsTracker;
import com.google.ar.sceneform.utilities.Preconditions;
import com.google.ar.sceneform.sceneformext.environment.Environment;
...
public class SceneView extends SurfaceView implements Choreographer.FrameCallback {
    ...
    public static final String DEFAULT_IBL_LOCATION = "environments/output/output_ibl.ktx"; //larger airport
    public static final String DEFAULT_SKYBOX_LOCATION = "environments/output/output_skybox.ktx"; //large airport
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!super.onTouchEvent(motionEvent)) {
            ...
            //Experiment to receive all hit test results
            scene.onTouchEventAll(motionEvent);
