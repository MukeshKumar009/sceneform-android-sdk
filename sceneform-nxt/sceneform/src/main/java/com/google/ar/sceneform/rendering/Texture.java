...
public class Texture {
  ...
  public static final class Builder {
    ...
    private static final int MAX_BITMAP_SIZE = 8192;//Changes the default size from 4096;
    ...
    private static TextureInternalData makeTextureData(
      ...
      // Fix in 1.68.1
      int filamentUsage = com.google.android.filament.Texture.Usage.SAMPLEABLE |
              com.google.android.filament.Texture.Usage.UPLOADABLE;

      if (mipLevels > 1) {
        filamentUsage |= com.google.android.filament.Texture.Usage.GEN_MIPMAPPABLE;
      }
      ...
      com.google.android.filament.Texture filamentTexture =
              new com.google.android.filament.Texture.Builder()
                      ...
                      .usage(filamentUsage) // Fix in 1.68.1
