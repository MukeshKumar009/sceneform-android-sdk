...
public class Node extends NodeParent implements TransformProvider {
    ...
    //Added for App SDK, because it has multiple scenes.
    ...
    /**
     * Return the parent scene name which this node belongs to.
     * @return
     */
    ...
    /**
     * Set the current scene name of the node. SDK has multiple scenes, so map the node with scene.
     * @param sceneName :  name of the parent scene
     */
