...
public class LightInstance {
  ...
  LightInstance(Light light, TransformProvider transformProvider) {
   ...
   // entity = EntityManager.get().create(); //This code is crashing here
    EntityManager entityManager = Filament.getEntityManager();
    ...
    if (light.getType() == Light.Type.POINT) {
      ...
      new LightManager.Builder(LightManager.Type.SPOT)
          ...
          .color(light.getColor().r, light.getColor().g, light.getColor().b)
          .intensity(light.getIntensity())
              .falloff(light.getFalloffRadius()) //Added by blippar to fix falloff issue
          .spotLightCone(
  ...
  private void updateProperties() {
    ...
    if (light.getType() == Light.Type.POINT) {
      ...
      lightManager.setFalloff(instance, light.getFalloffRadius()); //Added by blippar to fix falloff issue
