...
/**
 * Node that is automatically positioned in world space based on an ARCore NodeLocation.
 *
 * <p>When the NodeLocation isn't tracking, all children of this node are disabled.
 */
public class AnchorNode extends Node {
  ...
  /**
   * Set true to smooth the transition between the nodes current position and the anchor position.
  ...
  /** Returns true if the ARCore anchors tracking state is TRACKING. */
  ...
  /**
   * AnchorNode overrides this to update the node's position to match the ARCore NodeLocation's position.
   *
